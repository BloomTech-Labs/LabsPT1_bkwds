...
class MobileTopNav extends React.Component {
  ...
  openDrawer = () => {
    this.setState({ drawerOpen: true, drawerClasses: [...this.initialClasses, 'open-drawer'] })
  }

  closeDrawer = () => {
    this.setState({ drawerOpen: false, drawerClasses: [...this.initialClasses, 'close-drawer'] })
  }
  ...
  componentDidUpdate(_, prevState) {
    ...
    if(this.state.scrollY > 100 && this.state.drawerOpen) 
      this.closeDrawer()
    if(this.state.scrollY < 100 && !this.state.drawerOpen) 
      this.openDrawer()
  }
  ...
  render() {
    return (
        <s.MobileTopNavStyles id="MobileTopNavStyles">
          <div className={"banner-and-top-nav-wrapper " + this.state.drawerClasses.join(' ')} >
          <BannerContainer />
...
// const MobileTopNav = () => {
//   return (
//     <div id="PositionedParent" style={{ position: "relative" }}>
//       <s.MobileTopNavStyles id="MobileTopNavStyles">
//         <BannerContainer />
//         <div className="landing-page-nav">
